...
namespace DopplerBeplic.Tests
{
    public class GetConversationsByExternalIdAndDatesTests
    {
        ...
        {
            var expectedConversations = new GetConversationsByCustomerAndDatesResponse { Success = true, Conversations = 1 };
            ...
            Assert.Equal(conversations, expectedConversations.Conversations);
        }
    }
}
